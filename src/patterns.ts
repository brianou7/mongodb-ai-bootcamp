...
import { customerSummaryTool } from "./tools/customerSummaryTool";
import { failedTransactionsTool } from "./tools/failedTransactionsTool";
import { suspiciousSessionTool } from "./tools/suspiciousSessionTool";
...
export function toolsForPattern(pattern: Pattern): AgentTool[] {
  ...
  switch (pattern) {
    ...
    case "structured":
      return [structuredQuery, customerSummaryTool, failedTransactionsTool, suspiciousSessionTool, remember];
    case "hybrid":
      return [knowledgeBaseSearch, structuredQuery, assess, customerSummaryTool, failedTransactionsTool, suspiciousSessionTool, remember];
  }
}
